...
Chose whether or not the system should cache map images generated by MapBox. This uses a significant amount of disk space, and is only recommended if you are reaching the limits of the MapBox API.
...
```
6. The api should now be reachable at `http://<host_address>:8000`. E.g. `http://127.0.0.1:8000`, `http://localhost:8000`, `http://192.168.1.26:8000`.
